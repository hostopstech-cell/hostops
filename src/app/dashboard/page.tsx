  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div 
          className="bg-white rounded-lg p-4 shadow border border-slate-200 cursor-pointer hover:bg-slate-50 transition-colors"
        ...
        <div 
          ...
          onClick={() => router.push('/dashboard/bookings')}
        >
          <p className="text-sm text-slate-500">Today Check-outs</p>
