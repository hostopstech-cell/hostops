    ...
    <nav className="max-w-7xl mx-auto px-6 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/login" className="hidden md:block text-sm text-slate-600 hover:text-slate-900 transition-colors">Login</Link>
      ...
      {menuOpen && (
        <div className="md:hidden mt-4 pb-4 border-t border-slate-100 pt-4 flex flex-col gap-4">
          ...
          <Link href="/login" onClick={() => setMenuOpen(false)} className="text-sm text-slate-600">Login</Link>
